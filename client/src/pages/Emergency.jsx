  ...
  const immediateSteps = [
    {
      ...
      description: 'Immediately stop all communication with the suspected scammer',
      icon: '🛑'
    },
    {
      step: 2,
      title: 'Document Everything',
      description: 'Take screenshots, save emails, and record phone numbers',
      icon: '📸'
    },
    {
      step: 3,
      title: 'Secure Your Accounts',
      description: 'Change passwords and contact your bank/credit card companies',
      icon: '🔒'
    },
    {
      step: 4,
      title: 'Report the Scam',
      description: 'File reports with appropriate authorities and our platform',
      icon: '📋'
    },
    {
      step: 5,
      title: 'Monitor Your Accounts',
      description: 'Check bank statements and credit reports regularly',
      icon: '👁️'
    }
  ];
