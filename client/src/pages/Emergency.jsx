...
const Emergency = () => {
  ...
  const getContactColor = (type) => {
    switch (type) {
      case 'primary': return 'bg-[#065b7c] hover:bg-[#043a4d] text-white';
      case 'emergency': return 'bg-orange-600 hover:bg-orange-700 text-white';
      case 'secondary': return 'bg-[#021727] hover:bg-[#043a4d] text-white';
      default: return 'bg-gray-600 hover:bg-gray-700 text-white';
    }
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#021727] to-[#065b7c] py-8 text-gray-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <AlertTriangle className="h-16 w-16 mx-auto mb-4 text-yellow-400" />
          <h1 className="text-4xl font-bold text-white mb-4">Emergency Resources</h1>
          <p className="text-xl text-blue-100">
            Immediate help and resources for scam victims
          </p>
        </div>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">Emergency Contacts</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {emergencyContacts.map((contact, index) => (
              ...
              >
                ...
                <p className="text-blue-100 mb-3">{contact.description}</p>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">Immediate Steps to Take</h2>
          <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-lg p-8 border border-white/20">
            <div className="grid gap-6">
              {immediateSteps.map((item, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 bg-[#043a4d] rounded-full flex items-center justify-center text-2xl">
                    {item.icon}
                  </div>
                  <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {resources.map((resource, index) => (
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-lg rounded-xl shadow-lg p-6 border border-white/20"
              >
                <h3 className="text-xl font-semibold text-white mb-3">{resource.name}</h3>
                <p className="text-blue-100 mb-4">{resource.description}</p>
                <a
                  href={resource.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 text-[#00b4d8] hover:text-[#90e0ef] font-medium"
                >
        ...
        <section>
          <div className="bg-gradient-to-r from-[#021727] to-[#065b7c] text-white rounded-xl p-8 border border-white/20">
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-left">
                ...
                <div>
                  ...
                  <p className="text-blue-100">
                    Legitimate organizations won't ask for sensitive data via email or phone.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2">⏰ Take Your Time</h3>
                  <p className="text-blue-100">
                    Scammers create urgency. Legitimate offers allow time to think.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mt-8">
          <div className="bg-yellow-100 border border-yellow-300 rounded-xl p-6 text-gray-800">
